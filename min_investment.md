...
Gather Average Price per Sqft (from 3+ sources)
...
Add Transaction Costs (India example: 8%)
...
Source(s) (reputable portals/newspapers/reports): 
   • [Source Name] — Minimum Investment: [Currency] [X,XX,XXX] (published [Date])
Basis: [Direct source figure — used as primary input]
...
Data Sources: [List portals used or source figure]
Sample Size: [XX] properties analyzed
Data Recency: [Most recent listing date / Source publication date]
